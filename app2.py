...
st.markdown("This Analysis Dashboard that gives a relationship Between **Region** and Others Varios attributes used in production of designer of **High Fashion** Wears, based on Four REgions which are (East,West,North,South)")
...
with chart1:
    if x_axis and y_axis:
        fig=px.bar(df,x=x_axis, y=y_axis, color="Region" if color_encode else None, title="{} VS {}".format(x_axis.capitalize(), y_axis.capitalize()))
...
st.markdown("Analyzing Relationship Between Customer and Other Atrributes like(Total bill, Tips,Gender) with Each Day")
